...
export default function About() {
  ...
  return (
    <div>
      <body className={`font-sans antialiased ${isLightMode ? 'text-gray-900' : 'text-gray-100'} leading-normal tracking-wider bg-cover`} style={{ backgroundImage: "url('https://source.unsplash.com/1L71sPT5XKc')" }}>
        <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
          {/* Main Col */}
          <div id="profile" className={`w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0 ${isLightMode ? 'bg-white' : 'bg-gray-900'}`}>
            <div className="p-4 md:p-12 text-center lg:text-left">
              {/* Image for mobile view */}
              <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" style={{ backgroundImage: `url(${logo})` }}></div>
              <h1 className="text-3xl font-bold pt-8 lg:pt-0">KAYODE SOLARIN</h1>
              ...
              <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                ...
                </svg> CEO/FOUNDER STANDOUT ABODE 
              </p>
              ...
              <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                ...
                <a className="link" href="https://twitter.com/standoutabode?t=Hdm-aEsBH-Lcv0wLWc6upw&s=09" data-tippy-content="@twitter_handle">
                ...
                <a class="link" href="https://www.instagram.com/standoutabode" data-tippy-content="@instagram_handle">
                        <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a class="link" href="https://youtube.com/channel/UCzBkKFjaMMIKbYDZTd3u72g" data-tippy-content="@youtube_handle">
                    ...
                    <a className="mr-9 text-neutral-800 dark:text-neutral-200" href="https://www.linkedin.com/company/standoutabode">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-4 w-4"
            fill="currentColor"
          ...
          <div className="w-full lg:w-2/5">
            ...
            <img src={logo} className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" alt="profile" />
          </div>
